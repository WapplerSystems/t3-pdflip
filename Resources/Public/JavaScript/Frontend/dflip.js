...
! function(element, t) {
  ...
  var n,
    ...
    options = element.defaults = {
      ...
      pageMode: element.PAGE_MODE.AUTO,
      singlePageMode: element.SINGLE_PAGE_MODE.AUTO,
      backgroundColor: "#fff",
      forceFit: !0,
      transparent: !1,
      hard: "none",
      ...
      hideControls: "",
      controlsPosition: element.CONTROLSPOSITION.BOTTOM,
      paddingTop: 30,
      paddingLeft: 20,
      paddingRight: 20,
      paddingBottom: 30,
      ...
      shadowOpacity: .15,
      linkTarget: element.LINK_TARGET.BLANK,
    ...
    d = element.utils = {
      ...
      getSharePrefixes: function() {
        return (element.defaults.sharePrefix + ",dflip-,flipbook-,dearflip-").split(",").filter((function(e) {
          return e
        }))
      },
      toRad: function(e) {
      ...
      isBookletMode: function(t) {
        return t.pageMode == element.PAGE_MODE.SINGLE && t.singlePageMode == element.SINGLE_PAGE_MODE.BOOKLET
      },
      isRTLMode: function(t) {
        return t.direction == element.DIRECTION.RTL
      },
  ...
  var U = function(n, i) {
      ...
      var O = t(m.div, {
        ...
        R = (s.shareBox = new element.Share(n, r), s.share = t(m.div, {
  ...
  function W() {
    ...
    var i = function(t) {
      function n(n, i) {
        (n = n || {}).segments = n.segments || 50, this.pageCount = n.pageCount, this.height = n.height, this.width = n.width, this.direction = n.direction || element.DIRECTION.LTR, this.startPage = 1, this.endPage = this.pageCount, this.stackCount = n.stackCount || 6, this.materials = [], t.call(this, n, i), this.angles = [0, 0, 0, 0, 0, 0], this.stiffness = null == n.stiffness ? 1.5 : n.stiffness, this.hardConfig = n.hard, this._activePage = n.openPage || this.startPage, this.createStack(n), this.pageMode = n.pageMode || (A || this.pageCount <= 2 ? element.PAGE_MODE.SINGLE : element.PAGE_MODE.DOUBLE), this.singlePageMode = n.singlePageMode || (A ? element.SINGLE_PAGE_MODE.BOOKLET : element.SINGLE_PAGE_MODE.ZOOM), this.type = "Book"
      }
      ...
      return j(n, t), n.prototype.getPageByNumber = function(e) {
        ...
        null == t && (t = this.direction == element.DIRECTION.RTL ? -this.pageMode : this.pageMode), this.moveBy(t)
        ...
        for (var g = 5 / r, f = g * t / 2, m = g * (r - t) / 2, v = f < m ? m : f, b = 0; b < l; b++) {
          ...
          var I = c * b,
            S = 180 - c * (b - h) + c * b;
          if (b < h ? (P.newStiffness = C || 0 == this.stiffness ? 0 : u / (t / r) / 4, w = I, P.position.z = v - (-b + h) * d, 1 == p && (P.position.z -= d)) : (w = S, P.newStiffness = C || 0 == this.stiffness ? 0 : u / (Math.abs(r - t) / r) / 4, P.position.z = v - (-l + b + h + 1) * d - P.depth), 0 == P.isFlipping)
  ...
  var V = function(n) {
    function i(t) {
      ...
      n.zoomValue = 1, window.addEventListener("resize", i, !1), this.sound = document.createElement("audio"), this.sound.setAttribute("src", t.soundFile + "?ver=" + element.version), this.sound.setAttribute("type", "audio/mpeg"), this.autoPlayFunction = function() {
        n && n.target.autoPlay && (n.target.direction == element.DIRECTION.RTL ? n.target.prev() : n.target.next())
    ...
    return i.prototype = {
      ...
      resize: function() {
        ...
        if (null != n.target && null != n.target.ui && null != n.target.contentProvider && null != n.target.contentProvider.viewport && null != n.target.stage) {
          ...
          var I = u.find(".df-ui-controls").height(),
            S = h.paddingTop + (h.controlsPosition == element.CONTROLSPOSITION.TOP ? I : 0),
            E = h.paddingRight,
            k = h.paddingBottom + (h.controlsPosition == element.CONTROLSPOSITION.BOTTOM ? I : 0),
            T = h.paddingLeft,
      ...
      setPageMode: function(t) {
        1 == t ? (this.ui.pageMode.addClass(this.options.icons.doublepage), this.ui.pageMode.html("<span>" + this.options.text.doublePageMode + "</span>"), this.ui.pageMode.attr("title", this.options.text.doublePageMode), this.target.pageMode = element.PAGE_MODE.SINGLE) : (this.ui.pageMode.removeClass(this.options.icons.doublepage), this.ui.pageMode.html("<span>" + this.options.text.singlePageMode + "</span>"), this.ui.pageMode.attr("title", this.options.text.singlePageMode), this.target.pageMode = element.PAGE_MODE.DOUBLE), this.target && this.target.singlePageMode == element.SINGLE_PAGE_MODE.BOOKLET && this.target.reset(), this.resize()
      },
      ...
      checkCenter: function(t) {
        ...
        var n, i = this.target,
          ...
          h = u && i.singlePageMode == element.SINGLE_PAGE_MODE.BOOKLET,
          p = i.stage.width();
  ...
  var G = function(n) {
      function i(n, i, o, a) {
        o = o || {};
        var r = this;
        if (r.contentRawSource = n, r.contentSource = r.contentRawSource, r.contentSourceType = null, r.minDimension = o.minTextureSize || 256, r.maxDimension = o.maxTextureSize || 2048, r.pdfRenderQuality = o.pdfRenderQuality || element.defaults.pdfRenderQuality, r.flipbook = a, r.waitPeriod = 50, r.maxLength = 297, r.enableDebug = !1, r.zoomScale = 1, r.maxZoom = 2, r.options = o, r.outline = o.outline, r.links = o.links, r.html = o.html, r.isCrossOrigin = o.isCrossOrigin, r.normalViewport = {
            height: 297,
            width: 210,
            scale: 1
          }, r.viewport = {
          ...
          t("<img/>").attr("src", r.contentSource[0]).on("load", (function() {
            r.viewport.height = this.height,
              ...
              t(this).off(),
              r.options.pageSize == element.PAGE_SIZE.DOUBLEINTERNAL && (r.pageCount = 2 * r.contentSource.length - 2, 1 == r.options.webgl && (r.requiresImageTextureScaling = !0)), null != i && (i(r), i = null), E(this.height + ":" + this.width)
          }))
          ...
          var c = function() {
                  ...
                  r.pdfDocument = t, t.getPage(1).then((function(n) {
                    r.normalViewport = n.getViewport({
                      ...
                      if (r.options.pageSize == element.PAGE_SIZE.AUTO) {
                        ...
                        o.width / o.height > 1.5 * r.pageRatio ? (r.options.pageSize = element.PAGE_SIZE.DOUBLEINTERNAL, r.pageCount = 2 * t.numPages - 2) : r.options.pageSize = element.PAGE_SIZE.SINGLE
                      }
                      null != i && (i(r), i = null)
                    })) : null != i && (i(r), i = null)
            ...
            h = function() {
              if (r) {
                options.pdfjsWorkerSrc.indexOf("?ver") < 0 && (options.pdfjsWorkerSrc += "?ver=" + element.version), r.updateInfo(r.options.text.loading + " PDF Worker ...");
                ...
                n.href = options.pdfjsWorkerSrc,
                  n.hostname !== window.location.hostname ? (r.updateInfo(r.options.text.loading + " PDF Worker CORS ..."),
                    t.ajax({
                      ...
                      cache: !0,
                      success: function(t) {
                        options.pdfjsWorkerSrc = element.createObjectURL(t, "text/javascript"), c()
                      }
                    })) : c()
              }
            };
          null == window.pdfjsLib ? r && (r.updateInfo(r.options.text.loading + " PDF Service ..."),
            R(options.pdfjsSrc + "?ver=" + element.version,
              (function() {
                "function" == typeof define && define.amd && window.requirejs ? (r.updateInfo(r.options.text.loading + " PDF Service (require) ..."), require.config({
                  paths: {
                    "pdfjs-dist/build/pdf.worker": options.pdfjsWorkerSrc.replace(".js", "")
                  }
      ...
      return j(i, {}), i.prototype.updateInfo = function(e) {
        ...
        if (i.contentSourceType == p.PDF) {
          ...
          }), E(i.cacheIndex), i.annotedPage = void 0, i.review()
        ...
        var a = this,
          r = n = parseInt(n, 10),
          l = a.contentSource;
        n <= 0 && n >= a.pageCount ? a.setPage(n, options.textureLoadFallback, i, o) : a.contentSourceType == p.PDF ? null != a.getCache(n, o) ? (a.setPage(n, a.getCache(n, o), i, o), E("Page " + n + " loaded from cache")) : (!0 !== o && a.setLoading(n, !0), a.options.pageSize == element.PAGE_SIZE.DOUBLEINTERNAL && n > 2 && (r = Math.ceil((n - 1) / 2) + 1), l.getPage(r, o).then((function(t) {
          ! function(t, n, i, o) {
            var s = a.options.forceFit,
              r = a.options.pageSize == element.PAGE_SIZE.DOUBLEINTERNAL && n > 1 && n < a.pageCount,
              l = r && s ? 2 : 1,
              c = s ? t.getViewport({
                scale: 1
              }) : a.normalViewport,
            ...
            c = t.getViewport({
              scale: d
            }), E("rendering " + n + " at " + u.width + "x" + u.height), r && (N(a.targetObject) ? n % 2 == 0 && (c.transform[4] = -u.width) : n % 2 == 1 && (c.transform[4] = -u.width));
            var f = {
              canvasContext: g,
              viewport: c
            };
            t.cleanupAfterRender = !0, t.render(f).promise.then((function() {
              E(performance.now() - h), h = performance.now(), 1 == o || 1 == a.options.canvasToBlob && !0 !== a.webgl ? u.toBlob((function(t) {
                var s = element.createObjectURL(t, "image/jpeg");
        ...
        }))) : a.contentSourceType != p.IMAGE && a.contentSourceType != p.HTML || (null != a.getCache(n, o) ? (a.setPage(n, a.getCache(n, o), i, o), E("Page " + n + " loaded from cache")) : (!0 !== o && a.setLoading(n, !0), a.options.pageSize == element.PAGE_SIZE.DOUBLEINTERNAL && n > 2 && (r = Math.ceil((n - 1) / 2) + 1), function(e, n, i) {
        ...
        if (0 != i.options.enableAnnotation) {
          ...
          if (s.empty(), n > 0 && n <= i.pageCount) {
            if (i.contentSourceType == p.PDF) {
              O(n);
              var r = n;
              i.options.pageSize == element.PAGE_SIZE.DOUBLEINTERNAL && n > 2 && (r = Math.ceil((n - 1) / 2) + 1), a.getPage(r).then((function(e) {
        ...
        if (null != o && 0 != t(o).length) {
          ...
          return n.getAnnotations().then((function(c) {
            if (i = i.clone({
                dontFlip: !0
              }), r.options.pageSize, element.PAGE_SIZE.DOUBLEINTERNAL, null != o) {
              0 == (o = t(o)).find(".annotationDiv").length && o.append(t("<div class='annotationDiv'>"));
              var d = o.find(".annotationDiv");
              d.empty(), r.options.pageSize == element.PAGE_SIZE.DOUBLEINTERNAL && a > 1 && a < r.pageCount && (!l && a % 2 == 1 || l && a % 2 == 0) ? d.css({
                left: "-100%"
              }) : 1 == a && d.css({
                left: ""
              });
              ...
              if (pdfjsLib.AnnotationLayer.hasOwnProperty("render")) pdfjsLib.AnnotationLayer.render(u);
              else {
        ...
        tween: function(t) {
          ...
          if (null != n && null != n.parent) {
            var i, o = M(n.parent),
              ...
              r = n.parent.corner == element.CORNERS.BL || n.parent.corner == element.CORNERS.BR,
              l = 1 == n.magnetic,
            ...
            1 == n.isHard ? (null != t && (d = S(t.distance, t.fullWidth)), i = n.init = {
              angle: d * (a ? -1 : 1)
            }, u = n.end = n && 1 == n.animateToReset ? {
              angle: a ? 0 : -0
            } : {
            ...
            n.completeTween = n.completeTween || function(t) {
              n.isFlipping = !1, 1 == n.isHard ? (n.updateAngle(n.end.angle), n.back.css({
                ...
                x: n.end.x,
                y: n.end.y
              }), n.element[0].style.opacity = 1, !0 !== n.animateToReset ? n.side = n.side == g.right ? g.left : g.right : n.animateToReset = null, n.currentTween = null, n.pendingPoint = null, n.magnetic = !1, n.parent.dragPage = null, n.parent.corner = element.CORNERS.NONE, 1 != t && n.parent.refresh()
            };
    ...
    Z = function(n) {
      ...
      function o(n, o) {
        ...
        a.type = "BookCSS", a.images = n.images || [], a.pageCount = n.pageCount || 1, a.foldSense = 50, a.stackCount = 4, a.mode = "css", a.pages = [], a.duration = n.duration, a.container = t(o), a.options = n, a.drag = g.none, a.pageMode = n.pageMode || (A || a.pageCount <= 2 ? element.PAGE_MODE.SINGLE : element.PAGE_MODE.DOUBLE), a.singlePageMode = n.singlePageMode || (A ? element.SINGLE_PAGE_MODE.BOOKLET : element.SINGLE_PAGE_MODE.ZOOM), a.swipe_threshold = A ? 15 : 50, a.direction = n.direction || element.DIRECTION.LTR, a.startPage = 1, a.endPage = a.pageCount, a._activePage = n.openPage || a.startPage, a.hardConfig = n.hard, r = "WebKitCSSMatrix" in window || document.body && "MozPerspective" in document.body.style, a.animateF = function() {
        ...
        var l = function(t) {
              ...
              if (1 !== a.contentProvider.zoomScale) null == t.touches && 1 != a.isPanning || (a.pan(n), t.preventDefault());
                ...
                if (!i(a)) {
                  if (null != a.dragPage || 1 == n.isInside) {
                    ...
                    if (r.isHard) {
                      var c = l == element.CORNERS.BR || l == element.CORNERS.TR,
          ...
          c = function(t) {
            ...
            if (a.isPanning = !1, !(null != t.touches && t.touches.length > 1) && !0 !== a.skipDrag) {
              var n = a.eventToPoint(t);
              a.dragPage && (t.preventDefault(), a.dragPage.pendingPoint = n, n.x == a.startPoint.x && n.y == a.startPoint.y && 1 == n.isInside ? a.corner == element.CORNERS.BR || a.corner == element.CORNERS.TR ? (s(n), !0 !== a.dragPage.isFlipping && a.next()) : a.corner != element.CORNERS.BL && a.corner != element.CORNERS.TL || (s(n), !0 !== a.dragPage.isFlipping && a.prev()) : !0 !== a.dragPage.isFlipping && (n.distance > n.fullWidth / 2 ? n.x > n.fullWidth / 2 ? a.prev() : a.next() : (a.dragPage.animateToReset = !0, a.animatePage(a.dragPage))), a.dragPage && (a.dragPage.pendingPoint = null, a.dragPage.magnetic = !1)), a.drag = g.none
            }
          },
          u = function(t) {
            var n = a.eventToPoint(t),
              i = t.srcElement || t.originalTarget;
            a.dragPage && a.dragPage.magnetic || a.wrapper[0].contains(t.target) && 1 == a.contentProvider.zoomScale && n.x == a.startPoint.x && n.y == a.startPoint.y && n.isInsidePage && a.startPoint.page == n.page && !n.page.isFlipping && "A" !== i.nodeName && (0 == a.startPoint.page.side ? (a.corner = element.CORNERS.TL, a.prev(), a.startPoint.page = null) : (a.corner = element.CORNERS.TR, a.next(), a.startPoint.page = null), a.isPanning = !1)
          },
          h = function(t) {
      ...
      return j(o, {}), o.prototype = {
        ...
        pan: function(e) {
          ...
          this.left = Math.round(C(i, -this.shiftWidth, this.shiftWidth)), this.top = Math.round(C(o, -this.shiftHeight, this.shiftHeight)), 1 == n && (this.left = 0, this.top = 0), this.startPoint = e, this.stage.css({
    ...
    K = function(n) {
      function i(i, o, a) {
        ...
        s.type = "FlipBook",
          ...
          s.options.pageSize == element.PAGE_SIZE.DOUBLEINTERNAL && ((Array === s.contentSource.constructor || Array.isArray(s.contentSource) || s.contentSource instanceof Array) && (s.options.singlePageMode = element.SINGLE_PAGE_MODE.ZOOM), s.container.addClass("df-double-internal")), s.options.isLightBox || null == s.container.attr("id") || (s.options.id = s.container.attr("id")), !0 !== s.options.parsed && null != s.options.links && element.parseLinks(s.options.links);
        var r = s.webgl = 1 == a.webgl && 1 == _ && d.canSupport3D();
        if (i.addClass("df-container df-loading df-init df-floating df-controls-" + s.options.controlsPosition), s.commentPopup = t('<div class="df-comment-popup">').appendTo(i), 1 == s.options.transparent && i.addClass("df-transparent"), s.options.direction == element.DIRECTION.RTL && i.addClass("df-rtl"), s.container.info = t(m.div, {
            class: "loading-info"
        ...
        if (1 == n) {
          i = function() {
            a.container.css({
              minHeight: 300,
              minWidth: 300
            }), a.stage = new H(T(a.options, {
              container: a.container
            })), a.stage.previewObject = a, a.contentProvider = new G(a.contentSource, (function(i) {
              var o = {
              ...
              a.target = r = a.stage.target = new MOCKUP.Book(T(a.options, o), a.stage), a.extendtarget(), U(a.container, a), r.ui = a.ui, r.container = a.container, i.webgl = n, i.setTarget(a.target), r.getContentLayer = function(t) {
                ...
                if (a.contentProvider) {
                  ...
                  var n, i, o = O(r._activePage),
                    s = r.getPageByNumber(o),
                    l = r.getPageByNumber(o + 1),
                    c = r.parent.cssScene.divLeft,
                    d = r.parent.cssScene.divRight;
                  r.pageMode, element.PAGE_MODE.SINGLE, r.direction, element.DIRECTION.RTL, null != s && null != c && (n = Math.abs(s.geometry.boundingBox.max.x - s.geometry.boundingBox.min.x), i = Math.abs(s.geometry.boundingBox.max.z - s.geometry.boundingBox.min.z), c.rotation.y = .9 * -Math.atan2(i, n), c.position.z = .8 * i, c.position.x = i / 2.5, t(c.element).css({
                    width: n,
                    left: -n / 2
            ...
            return window.THREE = t, R(options.mockupjsSrc + "?ver=" + element.version, (function() {
              o()
            })), t
          }))) : "function" == typeof define && define.amd ? require(["three", options.threejsSrc.replace(".js", "")], (function(e, t) {
            e((function() {}))
          })) : R(options.threejsSrc + "?ver=" + element.version, (function() {
            R(options.mockupjsSrc + "?ver=" + element.version, (function() {
              o()
            }))
          }))) : o()
...
DFLIP.PDFFindController = function() {
  ...
  DFLIP.parseLinks = function(links) {
    ...
    if (null != links && links.length > 0)
      for (var n = 0; n < links.length; n++) null != (t = links[n]) && null != t[0] && null == t[0].dest && (t = DFLIP.ConvertPageLinks.apply(this, t), links[n] = t);
    return links
  },
  function(e) {
    function isBool(e) {
