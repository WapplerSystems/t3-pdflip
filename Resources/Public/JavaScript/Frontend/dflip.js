...
!(function (element, t) {
  ...
  var cssStyleDeclaration,
    ...
    utils = (element.utils = {
      ...
      isBookletMode: function (t) {
        return (
          t.pageMode == element.PAGE_MODE.SINGLE &&
          t.singlePageMode == element.SINGLE_PAGE_MODE.BOOKLET
        );
      },
  ...
  function initWebGL() {
    ...
    var Book = (function (t) {
      function n(n, i) {
        ...
        this.width = n.width;
        this.direction = n.direction || element.DIRECTION.LTR;
        this.startPage = 1;
          ...
          (n.prototype.updatePage = function (t) {
            ...
            for (
              ...
              ((P.textureLoaded = !1),
                ...
                (P.thumbLoaded = !1),
                P.backImage(options.textureLoadFallback),
                (P.backPageStamp = "-1"),
  ...
  var PreviewObject = (function (n) {
    function i(t) {
      ...
      this.sound.setAttribute("src", t.soundFile + "?ver=" + element.version);
        ...
        setPageMode: function (t) {
          1 == t
            ? (this.ui.pageMode.addClass(this.options.icons.doublepage),
              ...
              (this.target.pageMode = element.PAGE_MODE.SINGLE))
                ...
                o.promise.then(
                  function (t) {
                    ...
                    t.getPage(1).then(function (n) {
                      ...
                      r.zoomViewport = {
                        width:
                          (r.pageRatio > 1 ? 1 : r.pageRatio) * r.maxDimension,
                        height:
                          r.maxDimension / (r.pageRatio < 1 ? 1 : r.pageRatio),
                      };
                      r.refPage = n;
                      t.numPages > 1
                ...
                n.hostname !== window.location.hostname
                  ? (r.updateInfo(
                    ...
                    t.ajax({
                      ...
                      cache: !0,
                      success: function (t) {
                        options.pdfjsWorkerSrc = element.createObjectURL(
                          t,
                          "text/javascript",
                        );
                        c();
                      ...
                      require.config({
                        paths: {
                          "pdfjs-dist/build/pdf.worker":
                            options.pdfjsWorkerSrc.replace(".js", ""),
                        },
                      }),
            ...
            if (null != n && null != n.parent) {
              var i,
                ...
                r =
                  ...
                  n.parent.corner == element.CORNERS.BR,
                l = 1 == n.magnetic,
              ...
              n.completeTween =
                ...
                function (t) {
                  ...
                  n.parent.corner = element.CORNERS.NONE;
...
DFLIP.Share = (function (e) {
  function t(t, n) {
    ...
    i.isOpen = !1;
    i.shareUrl = "";
    i.wrapper = e('<div class="df-share-wrapper" style="display: none;">').on(
      "click",
      function (e) {
        i.close();
      },
...
DFLIP.Popup = (function (e) {
  function t(t, n) {
    var i = this;
    i.isOpen = !1;
    i.wrapper = e('<div class="df-popup-wrapper" style="display: none;">').on(
      "click",
      function (e) {
        i.close();
      },
...
(function (e) {
  ...
  DFLIP.getOptions = function (options) {
    ...
    (i = null == i || "" == i || null == window[i] ? {} : window[i]).source =
      null == source || "" == source ? i.source : source;
    ...
    return (
      (function (e) {
        if (1 != e.parsed) {
          ...
          var t = [];
          if (
            (n(e), "undefined" != typeof dFlipWPGlobal && "true" == e.wpOptions)
          ) {
            try {
